...
gulp.task('release', ['clean'], function () {
    var processedJsFile = 'chords-app.js'; // Convention: This name has to match the name in the build comment of the index.html
    ...
    var templateStream = gulp.src('./src/app/**/*.html')
        ...
        .pipe($$.angularTemplatecache('chords-templates.js', {
            module: 'chordsApp',
            base: basePath
        }));
